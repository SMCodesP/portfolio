	...
	return (
		<div className="container">
			<Head>
				...
				<meta
					property="og:title"
					content="SMCodes - Carrinho"
					key="title"
				/>
				<meta name="twitter:title" content="SMCodes - Carrinho" />
				<meta
					name="description"
					content="Configure e conclua suas compras aqui."
				/>
				<meta
			...
			<ContainerPage>
				{products.length > 0 ? (
					<>
						<ProductsShopping>
							...
							{products.map((product) => (
								<Product>
									<ImageIconProduct product={product} />
									<div
										style={{
											display: "flex",
					...
					>
						...
						>
							Você não tem nenhum produto no carrinho até o
							momento.
						</h1>
